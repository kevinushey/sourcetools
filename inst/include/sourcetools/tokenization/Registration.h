...
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SEMI,       (1 << 27));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMA,      (1 << 26));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SYMBOL,     (1 << 25));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMENT,    (1 << 24));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(WHITESPACE, (1 << 23));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(STRING,     (1 << 22));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(NUMBER,     (1 << 21));

/* Brackets */
#define SOURCE_TOOLS_BRACKET_BIT        (1 << 20)
...
/* Operators */
#define SOURCE_TOOLS_OPERATOR_BIT         (1 << 19)
