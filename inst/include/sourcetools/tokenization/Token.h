...
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SEMI,       (1 << 30));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMA,      (1 << 29));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SYMBOL,     (1 << 28));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMENT,    (1 << 27));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(WHITESPACE, (1 << 26));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(STRING,     (1 << 25));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(NUMBER,     (1 << 24));

/* Brackets */
#define SOURCE_TOOLS_BRACKET_BIT        (1 << 23)
...
/* Operators */
#define SOURCE_TOOLS_OPERATOR_BIT         (1 << 22)
...
#define SOURCE_TOOLS_KEYWORD_BIT               (1 << 21)
