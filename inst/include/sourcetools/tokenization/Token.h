...
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SEMI,       (1 << 29));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMA,      (1 << 28));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SYMBOL,     (1 << 27));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMENT,    (1 << 26));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(WHITESPACE, (1 << 25));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(STRING,     (1 << 24));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(NUMBER,     (1 << 23));

/* Brackets */
#define SOURCE_TOOLS_BRACKET_BIT        (1 << 22)
...
SOURCE_TOOLS_REGISTER_BRACKET(LPAREN,    SOURCE_TOOLS_BRACKET_LEFT_BIT, 0);
SOURCE_TOOLS_REGISTER_BRACKET(LBRACE,    SOURCE_TOOLS_BRACKET_LEFT_BIT, 1);
SOURCE_TOOLS_REGISTER_BRACKET(LBRACKET,  SOURCE_TOOLS_BRACKET_LEFT_BIT, 2);
SOURCE_TOOLS_REGISTER_BRACKET(LDBRACKET, SOURCE_TOOLS_BRACKET_LEFT_BIT, 3);

SOURCE_TOOLS_REGISTER_BRACKET(RPAREN,    SOURCE_TOOLS_BRACKET_RIGHT_BIT, 0);
SOURCE_TOOLS_REGISTER_BRACKET(RBRACE,    SOURCE_TOOLS_BRACKET_RIGHT_BIT, 1);
SOURCE_TOOLS_REGISTER_BRACKET(RBRACKET,  SOURCE_TOOLS_BRACKET_RIGHT_BIT, 2);
SOURCE_TOOLS_REGISTER_BRACKET(RDBRACKET, SOURCE_TOOLS_BRACKET_RIGHT_BIT, 3);

/* Operators */
#define SOURCE_TOOLS_OPERATOR_BIT         (1 << 21)
...
#define SOURCE_TOOLS_KEYWORD_BIT               (1 << 20)
