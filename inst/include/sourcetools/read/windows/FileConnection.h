#ifndef SOURCETOOLS__READ__WINDOWS__FILE_CONNECTION_H
#define SOURCETOOLS__READ__WINDOWS__FILE_CONNECTION_H
...
#endif /* SOURCETOOLS__READ__WINDOWS__FILE_CONNECTION_H */
