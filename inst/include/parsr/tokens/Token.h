...
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(ERR,        (1 <<  8));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SEMI,       (1 <<  9));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMA,      (1 << 10));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(SYMBOL,     (1 << 11));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(COMMENT,    (1 << 12));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(WHITESPACE, (1 << 13));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(STRING,     (1 << 14));
SOURCE_TOOLS_REGISTER_SIMPLE_TYPE(NUMBER,     (1 << 15));

/* Brackets */
#define SOURCE_TOOLS_BRACKET_BIT        (1 << 16)
#define SOURCE_TOOLS_BRACKET_RIGHT_BIT  (1 << 3)
#define SOURCE_TOOLS_BRACKET_LEFT_BIT   (1 << 2)
...
SOURCE_TOOLS_REGISTER_BRACKET(LPAREN,    SOURCE_TOOLS_BRACKET_LEFT_BIT, 0);  // 00010100
SOURCE_TOOLS_REGISTER_BRACKET(LBRACE,    SOURCE_TOOLS_BRACKET_LEFT_BIT, 1);  // 00010101
SOURCE_TOOLS_REGISTER_BRACKET(LBRACKET,  SOURCE_TOOLS_BRACKET_LEFT_BIT, 2);  // 00010110
SOURCE_TOOLS_REGISTER_BRACKET(LDBRACKET, SOURCE_TOOLS_BRACKET_LEFT_BIT, 3);  // 00010111

SOURCE_TOOLS_REGISTER_BRACKET(RPAREN,    SOURCE_TOOLS_BRACKET_RIGHT_BIT, 0); // 00011000
SOURCE_TOOLS_REGISTER_BRACKET(RBRACE,    SOURCE_TOOLS_BRACKET_RIGHT_BIT, 1); // 00011001
SOURCE_TOOLS_REGISTER_BRACKET(RBRACKET,  SOURCE_TOOLS_BRACKET_RIGHT_BIT, 2); // 00011010
SOURCE_TOOLS_REGISTER_BRACKET(RDBRACKET, SOURCE_TOOLS_BRACKET_RIGHT_BIT, 3); // 00011011

/* Operators */
#define SOURCE_TOOLS_OPERATOR_BIT        (1 << 17)
#define SOURCE_TOOLS_OPERATOR_UNARY_BIT  (1 << 5)
...
#define SOURCE_TOOLS_KEYWORD_BIT               (1 << 18)
#define SOURCE_TOOLS_KEYWORD_CONTROL_FLOW_BIT  (1 << 5)
...
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(ELSE,     2);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(REPEAT,   3);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(WHILE,    4);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(FUNCTION, 5);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(FOR,      6);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(IN,       7);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(NEXT,     8);
SOURCE_TOOLS_REGISTER_CONTROL_FLOW_KEYWORD(BREAK,    9);
...
public:
  ...
  bool isType(TokenType type) const { return SOURCE_TOOLS_CHECK_MASK(type_, type); }
...
inline bool isComplement(TokenType lhs, TokenType rhs)
{
  ...
  if (SOURCE_TOOLS_CHECK_MASK((lhs | rhs), mask))
    return SOURCE_TOOLS_LOWER_BITS(lhs, 2) == SOURCE_TOOLS_LOWER_BITS(rhs, 2);
